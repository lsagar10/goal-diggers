...
import 'package:goal_diggers/checkout.dart'; // Add the import for the Checkout page
import 'package:photo_view/photo_view.dart';
import 'package:flutter_rating_bar/flutter_rating_bar.dart'; // Import the rating bar package

class SocksProductDetailPage extends StatefulWidget {
  final String imageUrl;
  final String productName;
  final double price;
  final double originalPrice;

  const SocksProductDetailPage({
    super.key,
  ...
  @override
  State<SocksProductDetailPage> createState() => _SocksProductDetailPageState();
}

class _SocksProductDetailPageState extends State<SocksProductDetailPage> {
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Confirm Button - no gap at the bottom
              Padding(
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => Checkout(
                                  totalPrice: (widget.price).toStringAsFixed(0),
                                )),
                      );
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
