...
class BarcelonaDetailPage extends StatefulWidget {
  final String imageUrl;
  final String productName;
  final String price;
  final String originalPrice;

  const BarcelonaDetailPage({
    super.key,
  ...
  @override
  State<BarcelonaDetailPage> createState() => _BarcelonaDetailPageState();
}

class _BarcelonaDetailPageState extends State<BarcelonaDetailPage> {
