...
class LiverpoolDetailPage extends StatefulWidget {
  final String imageUrl;
  final String productName;
  final String price;
  final String originalPrice;

  const LiverpoolDetailPage({
    super.key,
  ...
  @override
  State<LiverpoolDetailPage> createState() => _LiverpoolDetailPageState();
}

class _LiverpoolDetailPageState extends State<LiverpoolDetailPage> {
  String selectedSize = 'M';
  int quantity = 1; // Variable to track quantity
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      final parsedPrice = double.tryParse(widget.price
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              'Rs ${(double.tryParse(widget.price.replaceAll(RegExp(r'[^0-9.]'), '')) ?? 0.0) * quantity}',
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 16,
                                color: Colors.green,
