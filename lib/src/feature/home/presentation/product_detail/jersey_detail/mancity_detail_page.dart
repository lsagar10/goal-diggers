...
class MancityDetailPage extends StatefulWidget {
  final String imageUrl;
  final String productName;
  final String price;
  final String originalPrice;

  const MancityDetailPage({
    super.key,
  ...
  @override
  State<MancityDetailPage> createState() => _MancityDetailPageState();
}

class _MancityDetailPageState extends State<MancityDetailPage> {
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      // Parse the price from the widget price
