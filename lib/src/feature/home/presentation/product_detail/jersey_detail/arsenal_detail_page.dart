...
import 'package:goal_diggers/checkout.dart'; // Import checkout page

class ArsenalDetailPage extends StatefulWidget {
  ...
  @override
  State<ArsenalDetailPage> createState() => _ArsenalDetailPageState();
}

class _ArsenalDetailPageState extends State<ArsenalDetailPage> {
  String selectedSize = 'M';
  final List<String> sizes = ['S', 'M', 'L', 'XL', 'XXL'];
  double rating = 4.5; // Set the product's rating here (out of 5)
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      CartModel.addToCart(
                        CartItem(
                          title: '${widget.productName} ($selectedSize)',
  ...
  // Checkout dialog with quantity selection
