...
class BayernDetailPage extends StatefulWidget {
  final String imageUrl;
  final String productName;
  final String price;
  final String originalPrice;

  const BayernDetailPage({
    super.key,
  ...
  @override
  State<BayernDetailPage> createState() => _BayernDetailPageState();
}

class _BayernDetailPageState extends State<BayernDetailPage> {
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              'Rs ${(double.tryParse(widget.price.replaceAll(RegExp(r'[^0-9.]'), '')) ?? 0)}',
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 16,
                                color: Colors.green,
