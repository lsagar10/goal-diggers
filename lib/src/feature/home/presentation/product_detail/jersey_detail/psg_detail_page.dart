...
import 'package:goal_diggers/checkout.dart'; // Import the checkout page

class PsgDetailPage extends StatefulWidget {
  ...
  @override
  State<PsgDetailPage> createState() => _PsgDetailPageState();
}

class _PsgDetailPageState extends State<PsgDetailPage> {
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              'Rs ${widget.price}', // Total amount here
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 16,
                                color: Colors.green,
