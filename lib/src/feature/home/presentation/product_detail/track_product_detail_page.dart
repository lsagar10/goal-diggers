...
class TrackProductDetailPage extends StatefulWidget {
  final String imageUrl;
  final String productName;
  final double price;
  final double originalPrice;

  const TrackProductDetailPage({
    super.key,
  ...
  @override
  State<TrackProductDetailPage> createState() => _TrackProductDetailPageState();
}

class _TrackProductDetailPageState extends State<TrackProductDetailPage> {
  ...
  // Show checkout bottom sheet like in RetroProductDetailPage
